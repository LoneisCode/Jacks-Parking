...
namespace JacksParkingBackEnd
{
    public class Startup
    {
        public Startup(IConfiguration configuration)
        {
            ...
            vSpots[2] = new ParkingSpot(144, 331, 82, 358, false); // Spot 2, empty || 3
            vSpots[3] = new ParkingSpot(182, 326, 125, 358, false); // Spot 3, taken
            vSpots[4] = new ParkingSpot(217, 325, 165, 357, false); // Spot 4, taken
            vSpots[5] = new ParkingSpot(252, 324, 206, 358, false); // Spot 5, taken
            vSpots[6] = new ParkingSpot(284, 324, 243, 358, false); // Spot 6, taken
            vSpots[7] = new ParkingSpot(317, 468, 284, 357, false); // Spot 7, taken
            vSpots[8] = new ParkingSpot(350, 319, 324, 358, false); // Spot 8, taken
            vSpots[9] = new ParkingSpot(381, 324, 362, 358, false); // Spot 9, empty || 4
            vSpots[10] = new ParkingSpot(419, 319, 401, 358, false); // Spot 10, taken
            vSpots[11] = new ParkingSpot(425, 323, 376, 358, true); // Spot 11, empty || 5
            ...
            vSpots[14] = new ParkingSpot(111, 280, 90, 287, false); // Spot 15, empty || 6
            ...
            vSpots[23] = new ParkingSpot(323, 275, 307, 287, false); // Spot 24, empty || 7 REGISTERING FALSE WHEN TRUE
            ...
            vSpots[40] = new ParkingSpot(366, 260, 384, 270, true); // spot 40, empty || 12 
